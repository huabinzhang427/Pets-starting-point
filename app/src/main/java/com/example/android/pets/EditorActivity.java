...
//        SQLiteDatabase db = mPetDbHelper.getWritableDatabase();
        ...
        if (mCurrentUri == null) {
            ...
            int rowsAffected = getContentResolver().update(mCurrentUri,
                    values,
                    null,
                    null);
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        ...
        String[] projection = new String[] {PetContract.PetEntry._ID,
    ...
    private void deletePet() {
        if (mCurrentUri != null) {
            ...
            int roewsDeleted = getContentResolver().delete(mCurrentUri, null, null);
